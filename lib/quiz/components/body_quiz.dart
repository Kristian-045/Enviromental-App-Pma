...
class BodyQuiz extends StatefulWidget {
  ...
  BodyQuiz({Key? key, required this.quiz, required this.questions}) : super(key: key);
  Quiz quiz;
  @override
  _QuizState createState() => _QuizState(questions);
}

class _QuizState extends State<BodyQuiz> {
  late Quiz _quiz ;
  ...
  Widget build(BuildContext context) {
    print("dlzkaa "+questions.length.toString());
